import{h as m,p as g,a as s,Y as f,N as r,k as e,E as c,g as _}from"./q-2alwOfKB.js";import{c as h}from"./q-UZ64HVBT.js";import{_ as d}from"./q-BOxSKDb4.js";const y=async()=>{const[n,l,o]=m();try{const t=await h.getContentByCode("GHHrrNrXYRDkkWuwZyYbEoIsSdZhCHDwtzvn2jD2elHbc0RgljqE7xd");t&&t.value_image&&t.value_image.length>0&&(o.value=t.value_image[0].image||"",console.log("Splash logo loaded:",o.value))}catch(t){console.error("Error loading splash logo:",t)}const a=1500,u=Date.now(),i=()=>{const t=Date.now()-u,p=Math.max(0,a-t);setTimeout(()=>{n.value=!1,setTimeout(()=>{l.value=!1},100)},p)};document.readyState==="complete"?i():window.addEventListener("load",i)},b=Object.freeze(Object.defineProperty({__proto__:null,_hW:_,s_GNA0T7zeUA8:y},Symbol.toStringTag,{value:"Module"})),v=`
    @keyframes fadeIn {
      from {
        opacity: 0;
        transform: scale(0.8);
